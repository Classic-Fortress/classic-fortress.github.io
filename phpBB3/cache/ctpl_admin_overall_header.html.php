...
<div id="wrap">
	<div id="page-header">
		...
		<p><a href="<?php echo (isset($this->_rootref['U_ADM_INDEX'])) ? $this->_rootref['U_ADM_INDEX'] : ''; ?>"><?php echo ((isset($this->_rootref['L_ADMIN_INDEX'])) ? $this->_rootref['L_ADMIN_INDEX'] : ((isset($user->lang['ADMIN_INDEX'])) ? $user->lang['ADMIN_INDEX'] : '{ ADMIN_INDEX }')); ?></a> &bull; <a href="<?php echo (isset($this->_rootref['U_INDEX'])) ? $this->_rootref['U_INDEX'] : ''; ?>"><?php echo ((isset($this->_rootref['L_FORUM_INDEX'])) ? $this->_rootref['L_FORUM_INDEX'] : ((isset($user->lang['FORUM_INDEX'])) ? $user->lang['FORUM_INDEX'] : '{ FORUM_INDEX }')); ?></a><?php if ($this->_rootref['STARGATE']) {  ?> &bull; <a href="<?php echo (isset($this->_rootref['U_PORTAL'])) ? $this->_rootref['U_PORTAL'] : ''; ?>"><?php echo ((isset($this->_rootref['L_PORTAL'])) ? $this->_rootref['L_PORTAL'] : ((isset($user->lang['PORTAL'])) ? $user->lang['PORTAL'] : '{ PORTAL }')); ?></a><?php } ?></p>
