...
window.App = function () {
    ...
    this.init = function () {
        require('./functions/binds')($);
        require('./functions/parseMarkdown')($);
        require('./functions/asyncPost')($);

        this.settings.activeTab = require('./functions/activeTab')($).trim();

        require('./views/community')($, this.settings.activeTab);
        require('./views/main')($);

        (function ($) {
            require('./functions/openLoginBox')(null, $);
        });
    };
};
...
},{"./functions/activeTab":4,"./functions/asyncPost":5,"./functions/binds":6,"./functions/openLoginBox":8,"./functions/parseMarkdown":9,"./views/community":10,"./views/main":11,"jquery":2}],2:[function(require,module,exports){
/*!
...
},{"./calcContentHeight":7,"./openLoginBox":8}],7:[function(require,module,exports){
'use strict';
...
module.exports = function ($, tab) {
    if (tab == 'community') {
        ...
        var forum = {
            ...
            enableRating: function enableRating() {
...
},{"marked":3}],11:[function(require,module,exports){
'use strict';
